...
export class NewsListComponent implements OnInit {
  ...
  getUser( currentPage : number = 1){
    ...
    // console.log(this.specificAreaNews)
    // this.specificAreaNews ? this.specificAreaNews = this.specificAreaNews : (this.specificAreaNews = "world");
    // if(this.specificAreaNews == "null"){
    //   this.specificAreaNews = "all";
    // }
